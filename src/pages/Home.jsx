    ...
    <div className='home w-full px-0 lg:px-10 pb-20 2xl:px-40 bg-bgColor lg:rounded-lg h-screen overflow-hidden'>
       ...
       <div className='w-full flex gap-2 lg:gap-4 pt-5 pb-10 h-full'>
          ...
          <div className='flex-1 h-full  px-4 flex flex-col gap-6 overflow-y-auto'>
                ...
                >
                  <div className='w-full flex itesm-center gap-2 py-4 border-b border-[#66666645]'>
                        <img 
                  ...
                  <div className='flex items-center justify-between py-4'>
                    <label
                      htmlFor='imgUpload'
                      className='flex items-center gap-1 text-base text-ascent-2 hover:text-asceent-1 cursor-pointer'
                    >
                        <input
                          type='file'
          ...
          <div className='hidden w-1/4 h-full lg:flex flex-col gap-8 overflow-y-auto'>
              ...
              <div className='w-full bg-primary shadow rounded-lg px-6 py-5'>
