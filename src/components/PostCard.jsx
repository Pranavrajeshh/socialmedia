...
const CommentForm=({user,id,replyAt,getComments})=>{
  ...
  return(
    <form onSubmit={handleSubmit(onSubmit)}
      className='w-full border-t border-[#66666645]'
    >
    ...
    <div className='mb-2 bg-primary p-4 rounded-xl'>
      ...
      <div className='flex gap-3 items-center mb-2'>
          ...
          <div className='w-full flex justify-between'>
            ...
            <Link to={'/profile/'+post?.userId?._id}>
              <p className='text-md font-medium text-ascent-1'>{post?.userId?.firstName} {post?.userId?.lastName}</p>
            </Link>
      ...
      <div className=''>
          <p className='text-ascent-2'>
              ...
              }
              {
                ...
                (
                  showAll===post?._id 
                  ? (<span className='text-blue ml-2 font-mediu cursor-pointer' onClick={()=>setShowAll(0)}>Show Less</span>) 
                  : (<span className='text-blue ml-2 font-mediu cursor-pointer' onClick={()=>setShowAll(post?._id)}>Show More</span>) 
                )
              }
          </p>
          {
